...
public class MailService {
    ...
    public void sendVerificationMail(User user) throws MessagingException, UnsupportedEncodingException {
        String toAddress = user.getEmail();
        String fromAddress = "renatoserrano13609@gmail.com";
        String senderName = "renato";
